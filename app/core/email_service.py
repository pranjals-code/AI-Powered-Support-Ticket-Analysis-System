    ...
    def __init__(self):
        ...
        if not self.smtp_configured:
            logger.warning(
                ...
                "Please configure SMTP settings in .env file to send real emails."
            )
...
Please use this code to reset your password. If you didn't request this, please ignore this email and your password will remain unchanged.
